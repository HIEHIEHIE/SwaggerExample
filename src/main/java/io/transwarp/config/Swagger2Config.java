...
@ComponentScan(basePackages = "io.transwarp.controller")
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                //扫描指定包中的swagger注解
                .apis(RequestHandlerSelectors.basePackage("io.transwarp.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("http://localhost:8080/SpringMVC_Swagger/swagger/index.jsp")
                .contact("Xia")
                .version("1.0.0")
                .build();
    }
